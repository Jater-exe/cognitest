...
func _ready() -> void:
	...
	if texture_button:
		texture_button.button_down.connect(_on_test_fa_texture_button_down)
		texture_button.button_up.connect(_on_test_fa_texture_button_up)

func _on_test_fa_texture_button_down() -> void:
...
func _on_test_fa_texture_button_up() -> void:
	if tween:
		tween.kill()	
