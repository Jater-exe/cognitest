...
func _ready() -> void:
	...
	scale = Vector2.ONE	
	var texture_button = get_node_or_null("Subjective - Button")
	if texture_button:
...
func _on_subjective__button_pressed() -> void:
	get_tree().change_scene_to_file("res://Scenes/Subjective_Control/subjective_control.tscn")
